...
class RestaurantModelDetail {
  RestaurantModelDetail({
    required this.error,
  ...
  factory RestaurantModelDetail.fromRawJson(String str) =>
      RestaurantModelDetail.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory RestaurantModelDetail.fromJson(Map<String, dynamic> json) =>
      RestaurantModelDetail(
        error: json["error"],
